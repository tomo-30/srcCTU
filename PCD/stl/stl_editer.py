...
class STLViewer(QtWidgets.QMainWindow):
    def __init__(self, parent=None):
        ...
        btn_reset_scale = QtWidgets.QPushButton("拡大縮小リセット")
        ...
        btn_reset_move = QtWidgets.QPushButton("移動リセット")
